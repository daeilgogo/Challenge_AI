...
function CategoryPage() {
        ...
        <div className="flex-col text-lg" align="center">
          ...
          <div className='text-2xl text-orange-400'>
            ...
            {stop && <button className="button2 mt-8 w-[150px] h-[50px] text-xl text-white bg-orange-400 shadow-lg rounded-xl"
              onClick={() => { navigate('/chat', { state: { category: Category } })}}>토론 시작하기</button>}
          </div>
        </div>
      </>
    )
  ...
  //navigate('/chat', { state: { category: Category } })
  //화면 : Home
  return (
    <div className='flex w-screen  items-center justify-center h-screen bg-white'>
      <div className=' flex w-full bg-white h-5/6 items-center justify-center rounded-2xl gap-10 flex-col'>
        <div className=' bg-[#F29104] w-full p-2 justify-center items-center flex fixed top-0'>
          <div className='w-full md:w-5/6 bg-[#F29104] p-3 rounded-xl flex justify-between gap-5 items-center'>
            <img className='w-9 h-8 hidden md:block' src={Logo} />
